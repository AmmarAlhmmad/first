        ...
        child: Container(
          child:
            ...
            Row(
              children: [
                AddReminerdersButtons(
                    icon: Icons.list, name: 'Unscheduled', label: null),
                AddReminerdersButtons(
                    icon: Icons.calendar_month, name: 'Scheduled', label: null),
              ],
            ),
            Container(
                margin: EdgeInsets.fromLTRB(25, 10, 0, 6),
                child: Text(
                  'Type of the repetation ',
                  style: TextStyle(
                    fontSize: 18,
                  ),
                )),
            Row(
              children: [
                AddReminerdersButtons(
                    icon: Icons.date_range, name: 'Specific Date', label: null),
                AddReminerdersButtons(
                    icon: Icons.cached, name: 'Whenever', label: null),
              ],
            ),
            Container(
                margin: EdgeInsets.fromLTRB(25, 10, 0, 6),
                child: Text(
                  'Domain of the reptition ',
                  style: TextStyle(
                    fontSize: 18,
                  ),
                )),
